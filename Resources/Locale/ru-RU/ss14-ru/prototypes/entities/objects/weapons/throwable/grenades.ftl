...
ent-MetalFoamGrenade = металлопенная граната
    .desc = Аварийное приспособление, используемое для заделывания пробоин с помощью специальной быстрозастывающей мателлической пены. Почти так же надёжно, как настоящие стены.
