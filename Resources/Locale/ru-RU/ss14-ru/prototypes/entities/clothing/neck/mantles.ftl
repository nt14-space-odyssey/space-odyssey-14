...
ent-ClothingNeckMantleCE = маника старшего инженера
    .desc = Сегментированный нарукавник для опытного старшего инженера, обозначающий опасность работы и риски, с которыми приходится сталкиваться, чтобы её заслужить.
