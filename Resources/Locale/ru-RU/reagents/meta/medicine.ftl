...
reagent-desc-diphenhydramine = Он же димедрол. Быстро очищает организм от гистамина, снижает нервозность и дрожь, вызывает усталость и лечит повреждения ядами. Часто входит в состав препаратов для сна.
